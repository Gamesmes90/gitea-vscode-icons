/** 
 * gitea-vscode-icons: shows vscode-icons on gitea repositories
 * Copyright (C) 2022 Gamesmes90
 * 
...
try{
    ...
    rootIconEl.setAttribute('class', 'gitea-vscode-icon');
    ...
    lastIconEl.setAttribute('class', 'gitea-vscode-icon');
